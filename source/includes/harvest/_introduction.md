...
| Date                          | Description                                                                                                                                                                                                                                                                                                                                                                                  |
|-------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Mar 28, 2024                  | Added `video_conferencing_url` parameter description to  [PATCH: Update Scheduled Interview](#patch-update-scheduled-interview) and [POST: Create Scheduled Interview](#post-create-scheduled-interview)                                                                                                                                                                                                   |
